...
enemyXPosition = random.randint(0,736)         #Giving enemy a random position on X-axis between range 0 to 800
...
while running:
    ...
    # --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
    collisionOccured = iscollision(bulletXPosition, bulletYPosition, enemyXPosition, enemyYPosition)  #If collision occurs from args of coordinates of bullet and enemy, it returns the value True otherwise False
    if collisionOccured:                        #If collOccured value returns True i.e collided
        ...
        print(score)
        enemyXPosition = random.randint(0, 735)  #Bring the enemy back to its default position and again a new enemy occurs from random position
        enemyYPosition = random.randint(0, 150)
